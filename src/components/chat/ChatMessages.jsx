...
const ChatMessages = ({oppositeProfile}) => {
  const { messages, loading, selectedConversation } = useGetMessages();
      ...
      {!loading &&
        ...
        messages.map((message) => (
            <div key={message._id} ref={lastMessageRef}>
              <ChatMessage message={message} oppositeProfile={oppositeProfile} />
            </div>
        ))}
        </div>
    </div>
