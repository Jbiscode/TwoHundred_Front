        ...
        <div>
            ...
            <div className="p-5">
                <form action="">
                    ...
                    <div className="mb-8">
                        <textarea placeholder="상대방에게 거래 후기를 작성해주세요!" maxLength={100} className="placeholder:text-base w-full min-h-64 border-solid border-black border p-5 text-base" name="" id="" onChange={(e) => {setReviewContent(e.target.value); setCharCount(e.target.value.length)}}></textarea>
